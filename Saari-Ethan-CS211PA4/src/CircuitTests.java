...
//
// Mac: compile/run:
//    demo$ javac -cp .:junit-cs211.jar CircuitTests.java
//    demo$ java  -cp .:junit-cs211.jar CircuitTests
//
// PC: compile/run:
//    demo$ javac -cp .;junit-cs211.jar CircuitTests.java
//    demo$ java  -cp .;junit-cs211.jar CircuitTests
...
public class CircuitTests {
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("CircuitTests");
  }
  ...
  public void circuit_andy() throws IOException {
